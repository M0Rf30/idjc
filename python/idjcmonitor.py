...
class IDJCMonitor(GObject):
    ...
    __gsignals__ = {
        'launch': (GObject.SignalFlags.RUN_LAST, GObject.TYPE_NONE,
                    (GObject.TYPE_STRING, GObject.TYPE_UINT)),
        'quit': (GObject.SignalFlags.RUN_LAST, GObject.TYPE_NONE,
                  (GObject.TYPE_STRING, GObject.TYPE_UINT)),
        'streamstate-changed': (GObject.SignalFlags.RUN_LAST, GObject.TYPE_NONE,
                                 (GObject.TYPE_INT, GObject.TYPE_BOOLEAN,
                                  GObject.TYPE_STRING)),
        'recordstate-changed': (GObject.SignalFlags.RUN_LAST, GObject.TYPE_NONE,
                                 (GObject.TYPE_INT, GObject.TYPE_BOOLEAN,
                                  GObject.TYPE_STRING)),
        'channelstate-changed': (GObject.SignalFlags.RUN_LAST, GObject.TYPE_NONE,
                                  (GObject.TYPE_UINT, GObject.TYPE_BOOLEAN)),
        'voip-mode-changed': (GObject.SignalFlags.RUN_LAST, GObject.TYPE_NONE,
                               (GObject.TYPE_UINT,)),
        'metadata-changed': (GObject.SignalFlags.RUN_LAST, GObject.TYPE_NONE,
                              (GObject.TYPE_STRING,) * 5),
        'effect-started': (GObject.SignalFlags.RUN_LAST, GObject.TYPE_NONE,
                           (GObject.TYPE_STRING,) * 2 + (GObject.TYPE_UINT,)),
        'effect-stopped': (GObject.SignalFlags.RUN_LAST, GObject.TYPE_NONE,
                           (GObject.TYPE_UINT,)),
        'player-started': (GObject.SignalFlags.RUN_LAST, GObject.TYPE_NONE,
                           (GObject.TYPE_STRING,)),
        'player-stopped': (GObject.SignalFlags.RUN_LAST, GObject.TYPE_NONE,
                           (GObject.TYPE_STRING,)),
        'tracks-finishing': (GObject.SignalFlags.RUN_LAST, GObject.TYPE_NONE,
                             ()),
        'announcement': (GObject.SignalFlags.RUN_LAST, GObject.TYPE_NONE,
                          (GObject.TYPE_STRING,) * 3),
        'frozen': (GObject.SignalFlags.RUN_LAST, GObject.TYPE_NONE,
                    (GObject.TYPE_STRING, GObject.TYPE_UINT,
    ...
    def do_get_property(self, prop):
        ...
        if name == "streaminfo":
            ...
            raise AttributeError("Unknown property %s in %s" % (name,
                                                                repr(self)))
